<nav class="navbar navbar-expand my-navbar" style = "background: #5371FF; color: white;">
      ...
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown">
          <!-- <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown">
            ...
            <button class="dropbtn" style = "color:black; background: #5371FF">
            ...
            <div class="dropdown-content">
                <a href="{{ route('admin-logout') }}" style = "font-size: 16px;">Logout</a>
                <!-- <a href="#">Link 2</a>
                <a href="#">Link 3</a> -->
            </div>
        </li>
